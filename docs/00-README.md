...
| 20 | [The owner's guides](guides/00-index.md) | **The twenty handover guides**, written for the person who owns the platform rather than for a developer. They ship inside the release package |
